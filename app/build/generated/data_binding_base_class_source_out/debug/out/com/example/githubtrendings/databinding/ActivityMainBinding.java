...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull ProgressBar progressBarBottom, @NonNull RecyclerView recyclerView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.progressBarBottom;
      ProgressBar progressBarBottom = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, progressBar, progressBarBottom,
          recyclerView, swipeRefresh, toolbar, tvEmpty, tvError);
    }
